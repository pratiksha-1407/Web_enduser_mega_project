...
const Sidebar = ({ isOpen, onClose, onNavigate, onLogout, user }) => {
    const sidebarWidth = '280px'; // Typical mobile drawer width
    ...
    const backdropStyle = {
        ...
        zIndex: 40, // Below sidebar, above content
        opacity: isOpen ? 1 : 0,
    ...
    const menuItems = [
        ...
        { icon: Package, label: 'Inventory', path: '/inventory' }, // Maps to Inventory Page
        { icon: ClipboardList, label: 'Production Orders', path: '/orders' }, // Maps to Orders Page
        // Additional items based on Flutter app usage (Attendance etc. if applicable to Prod Manager, 
        // but usually Pro Manager has different items. Following pro_dashboard routes: 
