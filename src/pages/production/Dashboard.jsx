...
import { fetchDashboardData } from '../../services/production/prodDashboardService';
// import '../../index.css';
...
import { logoutUser } from '../../services/production/prodProfileService';
...
const ProductionMetrics = ({ todayProduction, productionTarget, onRefresh }) => {
    ...
    return (
        <div style={{
            ...
            position: 'relative',
            overflow: 'hidden',
            boxShadow: `0 5px 15px ${colors.primaryBlue}4D`,
            marginBottom: '20px'
        }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                ...
                <div style={{
                    ...
                    <svg width="68" height="68" style={{ transform: 'rotate(-90deg)' }}>
                        ...
                        <circle
                            cx="34" cy="34" r={radius}
                            stroke={isTargetAchieved ? '#4ade80' : '#fbbf24'}
                            strokeWidth="6"
                            fill="none"
    ...
    return (
        <div style={styles.card}>
            ...
            <div style={{
                ...
                borderRadius: '12px',
                border: `1px solid ${marginColor}4D`,
                display: 'flex', justifyContent: 'space-between', alignItems: 'center'
            }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        <div style={styles.card}>
            ...
            {sortedCosts.map(([name, cost]) => (
                <div key={name} style={{
                    ...
                    <span style={{ fontSize: '14px', color: '#1F2937' }}>{name}</span>
                    <span style={{ fontSize: '14px', fontWeight: 700, color: '#FF9800', fontFamily: 'sans-serif' }}>
                        ₹{cost.toLocaleString()}
                    </span>
                </div>
            ))}
        ...
        <div style={styles.card}>
            ...
            {isEmpty ? (
                <div style={{ height: '200px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <span style={{ marginTop: '12px', fontSize: '14px', color: '#4B5563' }}>
                        No inventory data
                    </span>
                </div>
            ) : (
                inventory.slice(0, 4).map(item => {
                    const stock = (item.bags || 0);
                    const reorder = (item.min_bags_stock || 10);
                    ...
                    // Colors
                    const color = isLow ? colors.danger : colors.success;
    ...
    return (
        <div style={styles.container}>
            ...
            <Sidebar
                ...
                user={{ full_name: 'Production Manager', position: 'Manager' }}
            />
